...
from jobdrop.glassdoor.constant import fallback_token, query_template
from jobdrop.glassdoor.util import (
    get_cursor_for_page,
    parse_compensation,
    parse_location,
)
...
def _run_on_thread(coro):
    ...
    Uses a dedicated thread + new loop. Mirrors the pattern in jobdrop/google."""
    import threading
